(function() {
  ...
  var TreeNode1 = function(text, offset, elements) {
    ...
    this['pname'] = elements[2];
  };
  inherit(TreeNode1, TreeNode);

  var TreeNode2 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['pname'] = elements[1];
  };
  ...
  var Grammar = {
    _read_start: function() {
      ...
      if (address0 === FAILURE) {
        this._offset = index1;
        address0 = this._read_bpm();
        if (address0 === FAILURE) {
          this._offset = index1;
          address0 = this._read_meter();
          if (address0 === FAILURE) {
            this._offset = index1;
        ...
        if (address2 !== FAILURE) {
          ...
          if (address3 !== FAILURE) {
            ...
            if (elements1 === null) {
              ...
              address4 = new TreeNode2(this._input.substring(index3, this._offset), index3, elements1);
            ...
            if (address4 !== FAILURE) {
              ...
              while (address8 !== FAILURE) {
                ...
                if (elements3 === null) {
                  ...
                  address8 = new TreeNode3(this._input.substring(index5, this._offset), index5, elements3);
                  this._offset = this._offset;
                }
                if (address8 !== FAILURE) {
    ...
    _read_bpm: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._bpm = this._cache._bpm || {};
      var cached = this._cache._bpm[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      this._cache._bpm[index0] = [address0, this._offset];
      return address0;
    },

    _read_meter: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._meter = this._cache._meter || {};
      var cached = this._cache._meter[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (chunk0 === 'Clock.meter') {
        ...
        if (this._offset === this._failure) {
          this._expected.push('"Clock.meter"');
        }
      }
      if (address1 !== FAILURE) {
        elements0[0] = address1;
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.make_meter(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._meter[index0] = [address0, this._offset];
      return address0;
    },
      ...
      if (address1 !== FAILURE) {
        ...
        while (address3 !== FAILURE) {
          ...
          if (elements2 === null) {
            ...
            address3 = new TreeNode10(this._input.substring(index3, this._offset), index3, elements2);
            this._offset = this._offset;
          }
          if (address3 !== FAILURE) {
    ...
    _read_param: function() {
      ...
      if (address0 === FAILURE) {
        ...
        if (address0 === FAILURE) {
          ...
          var address7 = FAILURE;
          var remaining0 = 0, index5 = this._offset, elements3 = [], address8 = true;
          while (address8 !== FAILURE) {
            address8 = this._read_array();
            if (address8 !== FAILURE) {
          ...
          if (address7 !== FAILURE) {
            ...
            var address9 = FAILURE;
            var remaining1 = 0, index6 = this._offset, elements4 = [], address10 = true;
            ...
            if (address9 !== FAILURE) {
              ...
              var address11 = FAILURE;
              var remaining2 = 0, index7 = this._offset, elements5 = [], address12 = true;
              while (address12 !== FAILURE) {
                address12 = this._read_pattern();
              ...
              if (remaining2 <= 0) {
                address11 = new TreeNode(this._input.substring(index7, this._offset), index7, elements5);
                this._offset = this._offset;
              } else {
                address11 = FAILURE;
              }
              if (address11 !== FAILURE) {
                elements2[2] = address11;
                var address13 = FAILURE;
                var remaining3 = 0, index8 = this._offset, elements6 = [], address14 = true;
          ...
          if (elements2 === null) {
            ...
            address0 = this._actions.make_nonattribute(this._input, index4, this._offset, elements2);
            this._offset = this._offset;
          }
          if (address0 === FAILURE) {
            this._offset = index1;
    ...
    _read_pattern: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._pattern = this._cache._pattern || {};
      var cached = this._cache._pattern[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.make_pattern(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._pattern[index0] = [address0, this._offset];
      return address0;
    },
    ...
    _read_file: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        var address3 = FAILURE;
        var remaining0 = 0, index3 = this._offset, elements2 = [], address4 = true;
        while (address4 !== FAILURE) {
          address4 = this._read_string();
          if (address4 !== FAILURE) {
        ...
        if (address3 !== FAILURE) {
          ...
          var address5 = FAILURE;
          var remaining1 = 0, index4 = this._offset, elements3 = [], address6 = true;
          while (address6 !== FAILURE) {
            address6 = this._read_number();
            if (address6 !== FAILURE) {
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.make_file(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
    ...
    _read_special: function() {
      ...
      while (address1 !== FAILURE) {
        ...
        if (chunk0 !== null && /^[~!@#$%^&*-=+:\/\\1234\\\|]/.test(chunk0)) {
          address1 = new TreeNode(this._input.substring(this._offset, this._offset + 1), this._offset);
          this._offset = this._offset + 1;
        } else {
          address1 = FAILURE;
      ...
      if (remaining0 <= 0) {
        address0 = this._actions.make_special(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      } else {
        address0 = FAILURE;
      }
    ...
    _read_fraction: function() {
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.make_fraction(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
