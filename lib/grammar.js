    ...
    _read_pattributes: function() {
      ...
      if (address0 === FAILURE) {
        ...
        if (elements1 === null) {
          ...
          address0 = new TreeNode13(this._input.substring(index3, this._offset), index3, elements1);
          this._offset = this._offset;
        }
        if (address0 === FAILURE) {
          this._offset = index1;
        ...
        if (address2 !== FAILURE) {
          ...
          while (address4 !== FAILURE) {
            ...
            if (elements2 === null) {
              ...
              address4 = new TreeNode16(this._input.substring(index3, this._offset), index3, elements2);
              this._offset = this._offset;
            }
            if (address4 !== FAILURE) {
