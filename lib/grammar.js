  ...
  var Grammar = {
    ...
    _read_params: function() {
      ...
      if (address1 !== FAILURE) {
        ...
        while (address3 !== FAILURE) {
          ...
          if (elements2 === null) {
            ...
            address3 = new TreeNode8(this._input.substring(index4, this._offset), index4, elements2);
            this._offset = this._offset;
          }
          if (address3 !== FAILURE) {
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.make_param(this._input, index2, this._offset, elements0);
        this._offset = this._offset;
      }
      if (address0 === FAILURE) {
        this._offset = index1;
        ...
        var address6 = FAILURE;
        address6 = this._read_array();
        if (address6 !== FAILURE) {
          elements3[0] = address6;
          var address7 = FAILURE;
          var remaining1 = 0, index6 = this._offset, elements4 = [], address8 = true;
          while (address8 !== FAILURE) {
            var index7 = this._offset, elements5 = new Array(2);
            var address9 = FAILURE;
            var chunk1 = null;
            if (this._offset < this._inputSize) {
              chunk1 = this._input.substring(this._offset, this._offset + 1);
            ...
            if (address9 !== FAILURE) {
              elements5[0] = address9;
              var address10 = FAILURE;
              address10 = this._read_param();
              if (address10 !== FAILURE) {
                elements5[1] = address10;
              } else {
                elements5 = null;
                this._offset = index7;
              }
            ...
            if (elements5 === null) {
              ...
              address8 = new TreeNode10(this._input.substring(index7, this._offset), index7, elements5);
              this._offset = this._offset;
            }
            if (address8 !== FAILURE) {
        ...
        if (elements3 === null) {
          ...
          address0 = this._actions.make_param(this._input, index5, this._offset, elements3);
          this._offset = this._offset;
        }
        if (address0 === FAILURE) {
          this._offset = index1;
    ...
    _read_pattributes: function() {
      ...
      if (elements0 === null) {
        ...
        address0 = new TreeNode13(this._input.substring(index2, this._offset), index2, elements0);
        this._offset = this._offset;
      }
      if (address0 === FAILURE) {
        this._offset = index1;
        ...
        if (elements1 === null) {
          ...
          address0 = new TreeNode14(this._input.substring(index3, this._offset), index3, elements1);
          this._offset = this._offset;
        }
        if (address0 === FAILURE) {
          this._offset = index1;
        ...
        if (address2 !== FAILURE) {
          ...
          while (address4 !== FAILURE) {
            ...
            if (elements2 === null) {
              ...
              address4 = new TreeNode17(this._input.substring(index3, this._offset), index3, elements2);
              this._offset = this._offset;
            }
            if (address4 !== FAILURE) {
    ...
    _read_DQ: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._DQ = this._cache._DQ || {};
      var cached = this._cache._DQ[index0];
      if (cached) {
        this._offset = cached[1];
        return cached[0];
      }
      ...
      this._cache._DQ[index0] = [address0, this._offset];
      return address0;
    },
